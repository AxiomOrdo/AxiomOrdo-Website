    ...
    <section className="py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-zinc-400 mb-8 max-w-lg mx-auto">Use the available local tools without an account. Each planned capability remains clearly gated until it is real.</p>
