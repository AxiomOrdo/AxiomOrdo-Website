...
These operational-draft terms govern use of AO-PDF, a service provided by AxiomOrdo Ltd. Contact hello@axiomordo.com with questions.
...
Published file, page, image, geometry, timeout and estimated working-memory limits apply. Browser capabilities and device resources vary. AO-PDF may reject unsupported, encrypted, malformed or unusually structured documents with a governed error.

## Governing law

These terms and disputes arising from them are governed by the laws of England and Wales, and the courts of England and Wales have jurisdiction.
